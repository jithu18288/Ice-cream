                ...
                <ul id="navbar"> <Link to="/">
                   ...
                   <Link to="/about">
                    ...
                    <li>
                      ...
                      <div className="dropdown-btn" onClick={(e)=> setIsActive(!isActive)}><a>FLAVOURS</a>
                      <span className="fas fa-caret-down"></span>
                      </div>
                      {isActive && ( 
                      <div className="dropdown-content">
                        <div className="dropdown-item"> <Link to="/basic"><button>Basic</button></Link></div>
                        <div className="dropdown-item"> <Link to="/fruit"><button>Fruit</button></Link></div>
                        <div className="dropdown-item"> <Link to="/nut"><button>Nut</button></Link></div>
                        </div>
                      )}
                        </div>
                    </li>
